...
exports.BCR_QA_LABEL = exports.GROUP_HALL_QUESTIONS = exports.QA_PAIRS = void 0;
exports.getBcrQaPairs = getBcrQaPairs;
const bcrTextHumanize_1 = require("./bcrTextHumanize");
exports.QA_PAIRS = [
    // --- Nhóm ---
...
exports.GROUP_HALL_QUESTIONS = exports.QA_PAIRS.map((p) => p.question).concat([
...
function getBcrQaPairs(count = 60) {
    const unique = exports.QA_PAIRS.slice(0, Math.min(count, exports.QA_PAIRS.length));
    const result = shufflePairs([...unique]);
    return result.map((p) => ({
        ...p,
        question: (0, bcrTextHumanize_1.maybeApplyTypos)(p.question),
        answer: (0, bcrTextHumanize_1.maybeApplyTypos)(p.answer),
    }));
}
